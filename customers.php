...
<div class="container">
        <h2 class="text-center pt-4" style="color : black;font-family: 'Times New Roman', Times, serif;" >Our Customers</h2>
        <br>
            <div class="row">
                <div class="col">
                    <div class="table-responsive-sm">
                    <table class="table table-hover table-sm table-striped table-condensed table-bordered" style="   border: 5px; ">
                        <thead style="color : black; font-family: 'Times New Roman', Times, serif;">
                            <tr>
